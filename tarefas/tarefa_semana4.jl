...
- Faça o upload do Notebook Pluto com nome `Tarefa4_Meu_Nome.pluto.jl` na Tarefa 2  no Moodle

- Não esqueça de incluir as **Referências** consultadas, incluindo pessoas.

- Você abrir diretamente no Pluto a tarefa usando o seguinte [link](https://github.com/lrsantos11/metodos-numericos/raw/2021-2/tarefas/tarefa_semana4.jl)
"""
