...
# ╔═╡ dea8ea0b-dd89-4f88-a75c-51f603df95e7
names(df_sc)
...
md"""
Pacote [`LsqFit.jl`](https://github.com/JuliaNLSolvers/LsqFit.jl) precisa:
...
plt_casos = @df df_sc plot(xdata, :totalCases, label = "Total de Casos", leg = :bottomright, size=(600,300),lw=2, title = "Total de Casos em SC")
...
# ╔═╡ 231f0d9f-00ee-492a-bbcb-c16cde89f6cd
...
fit_log = curve_fit(logistic_model, xdata, ydata, [0.5, 0.5, 1e6])
...
# ╔═╡ 4dcdea22-828f-4898-b767-0d2873516ab8
total_casos_SC = last(df_sc.totalCases)

# ╔═╡ 0c240c06-af84-4474-8103-3b58dd452d27
err_rel_log = norm(fit_log.resid)/total_casos_SC

# ╔═╡ 24c4b349-41a5-43da-af1a-71889b1fed24
plt_log = plot(plt_casos, x->logistic_model(x,β_log), 0, 750, label = "Logístico ($err_rel_log)")
...
err_rel_gom = norm(fit_gom.resid)/total_casos_SC

# ╔═╡ 55b9ae65-b544-4ba1-898a-cf718edcffac
β_gom = fit_gom.param

# ╔═╡ 0e69917d-6942-465d-aefb-782104f4d0e7
plot(plt_log, x->gompertz_model(x,β_gom),  label = "Gompertz ($err_rel_gom)")
