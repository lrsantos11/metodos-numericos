...
# ╔═╡ 938c8adf-3b53-4189-a881-bb4e4792da0c
md"""
...
com $f:\mathbb{R}^n \to \mathbb{R}$. 

Dizemos que $x^*\in\mathbb{R}^n$ é um __ponto estacionário__ de $f$ se 

$\nabla f(x^*) = 0.$ 
"""

# ╔═╡ 84f5faf4-e43b-4541-94fc-6d0a403d8eba
#Exemplo
let
	f(x) = x[1]^2 + x[2]^4 + 1
	f(x,y) = f([x,y])
