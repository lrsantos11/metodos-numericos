...
# ╔═╡ b1863daa-aa7e-4dc9-866a-8bff94981667
md"""
# O Problema de Quadrados Mínimos

- Quando $b\notin \mathcal{Im}(A)$, temos que o sistema linear

$Ax = b$
não tem solução. Logo, o erro absoluto $e_A = b-Ax \neq 0$, para todo $x\in \mathbb{R}^n$. Assim, gostaríamos de encontrar o vetor $x^*$ que minimize a norma de $e_A$:

$x^* = \operatorname{arg\, min} \lVert e_A\rVert = \lVert b - Ax\rVert$


Este problema é equivalente a encontrar a solução de


$\min_x \frac{1}{2}\| b - Ax\|^2$
"""

# ╔═╡ 2308e627-ab06-44f8-89b7-0fb6099713da
md"""
## Ajuste de Curvas e Método dos Quadrados Mínimos
- Qual curva melhor representa ou melhor se ajusta a um conjunto de dados?
"""

# ╔═╡ e96cfb93-d7de-4f72-a565-b7cb85468180
md"Incluir retas $(@bind retas CheckBox())"


# ╔═╡ 024ae2f0-58cc-4c98-9aea-df3dfec22ce0
begin
	Random.seed!(11)
...
# ╔═╡ a8300dc5-ced3-42b6-887c-c453cbd96ac3
md"""
- Solução $x^*$ das equações normais $A^TAx = A^Tb$ é uma solução do problema de quadrados mínimos. Se $A$ tiver posto completo, $A^TA$ é definida postiva e logo, $x^*$ é único.
"""


# ╔═╡ 435d1cb3-5897-4c80-969a-2abd0a658783
begin
	A = [x_data ones(n)]
	B = A'*A
	b = A'*y_data
	α = B  \ b  # O Comando B \ b resolve o sitema linear Bα  = b
	plot(p,  x -> α[1]*x + α[2],lw = 3)
end

# ╔═╡ 3ed765b4-e2d7-4c7a-b958-62fd05fd71bb
norm(y_data - A*α) #norma do erro

# ╔═╡ 495c9efe-fc26-4e78-9274-5ba0dd767381
begin
...
# ╔═╡ e990e80f-ec34-4ee1-a81e-914e6fa4ca10
norm(y_data - A2*β2)

# ╔═╡ 23ee8361-f9d3-4edc-8487-85a5b46094e9
begin
...
# ╔═╡ ea57a908-38c8-4415-b840-a407a9c1f207
norm(y_data - A3*β3)

# ╔═╡ 7a14dab3-5d20-439f-89fb-c89042b319db
β3

# ╔═╡ c95b62f6-72ab-4fff-ba1d-980e2dac45a8
md"""
...
# ╔═╡ e8bc5423-5ce8-4def-a868-e7e78bbe6338
begin
...
# ╔═╡ 578bd28d-3146-4c25-83c5-ee2cc0eb61ab
md"""
...
# ╔═╡ 5337c76d-01c0-4b81-a46c-4f4152face14
md"""
...
# ╔═╡ c5daaa35-f208-4145-8417-af166c03e75f
md"""
...
# ╔═╡ d2893a9b-a14c-4531-bcf5-38c98a7cd626
md"""
...
# ╔═╡ f0f47fdd-9c52-419d-99df-9eebb188e6b7
phi(x) = c[1].*1  + c[2].*x +  c[3].*x.^2


# ╔═╡ 099466c7-593b-4036-9e90-d5003651cc98
begin
...
# ╔═╡ 7fe6ba67-5f31-456c-9423-79c14458b12c
c


# ╔═╡ d86fba2b-39d0-44d6-8c7e-b4e21fdeb262
