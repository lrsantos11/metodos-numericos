...
# ╔═╡ 7721e5aa-cf9b-44d9-9c71-d8debb4b10a1
eps(BigFloat(1))
...
function raizes_big(a,b,c)
	...
	r₁, r₂ = raizes(a,b,c) 
	return float(r₁), float(r₂) # Float32
end
...
# ╔═╡ a464c5f8-2d9c-4449-97a4-34e7438b473a
π^2/6
...
begin
	...
	xlims!(0,35)
	ylims!(0,12)
	plot!(log2.(Ns),-log_erro_π_dec, label="Ordem decrescente", marker=:star)
end
