...
$|x_k-x^*|\leq \frac{b_k-a_k}{2} = \frac{b_0-a_0}{2^k} \cdot \frac{1}{2} =  \frac{b_0-a_0}{2^{k+1}},$
...
let
	...
	with_terminal(println, "Raiz quadrada de $(a) é aproximadamente $(xₖ)
		                    \n O método de Newton deu $(k) interações
...
git-tree-sha1 = "b29c63ad0b1fb313bf42f6bb1260959cbaf57b8b"
